...
const TransferManagersRights = () => {
    ...
    const TransferRights = (id) => {
        history.push({
            pathname: '/managers/transfer_rights',
                ...
                <MaterialTable
                    ...
                    actions={[
                        ...
                        },
                        {
                            ...
                            onClick: (event, listRecords) => { TransferRights(listRecords.id) }
                        },
                        // {
                        //     icon: 'delete',
                        //     tooltip: 'delete',
...
export default TransferManagersRights;